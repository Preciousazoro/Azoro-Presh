      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-6xl">
        ...
        <div>
          ...
          <div className="relative pl-8 border-l-2 border-gray-300 dark:border-gray-800">
            <span className="absolute -left-[9px] top-1.5 w-4 h-4 bg-[#ff004f] rounded-full"></span>
            <h4 className="font-semibold text-lg">Web Development Certification – Udemy</h4>
            <p className="text-gray-600 dark:text-gray-400 flex gap-1 text-sm mb-1">
              <FaAward className="text-[#ff004f]" /> 
              Completed full-stack web development curriculum, <br />
              Learned React, Node.js, MongoDB, and modern web tools
            </p>
            <p className="text-[#ff004f] text-sm flex items-center gap-1 mt-2">
        ...
        <div>
          ...
          <div className="relative pl-8 border-l-2 border-gray-300 dark:border-gray-800 mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-1">
              Built responsive web applications using React, Next.js, and Node.js, <br />
              Improved UI performance and accessibility across devices, <br /> 
              Collaborated with clients to deliver scalable web solutions.
            </p>
            <p className="text-[#ff004f] text-sm flex items-center gap-1 mt-2">
              <FaCalendarAlt className="text-[#ff004f]" /> 2024 – 2026
            </p>
          </div>
          ...
          <div className="relative pl-8 border-l-2 border-gray-300 dark:border-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-1">
              Implemented responsive layouts to ensure optimal performance across desktop, tablet, and mobile devices. 
            </p>
            <p className="text-[#ff004f] text-sm flex items-center gap-1 mt-2">
              <FaCalendarAlt className="text-[#ff004f]" /> 2024 – 2026
            </p>
